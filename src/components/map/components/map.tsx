...
const MapboxMap = memo(function _MapboxMap({
  ...
  // 13.16 32:29  Error: React Hook "useAtom" is called in function "_MapboxMap" that is neither a React function component
  // nor a custom React Hook function. React component names must start with an uppercase letter. React Hook names must
